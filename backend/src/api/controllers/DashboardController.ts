...
export class DashboardController {
  static async getStats(req: AuthenticatedRequest, res: Response) {
    ...
    try {
      ...
      const occupiedOrReservedTables = allTables.filter(t => 
      ...
      const activeBookingsToday = todayReservations.filter(r => 
      ...
      const clientBookings: { [email: string]: { name: string; count: number; phone: string } } = {};
      allReservations.forEach(r => {
